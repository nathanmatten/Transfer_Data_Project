...
```{r Data Wrangling/Merging, cache=TRUE}
...
for (i in 1:nrow(tran_loo)){
  ...
  lmmodel = lm(bpm2 ~ bpm + ts + g + usg, data = tran_loo)
...
The RMSE of self-implemented "leave one out" is: `r round(RMSE_loo,4)`. This is the same as the RMSE of the regular LM model... not sure why that is? 
